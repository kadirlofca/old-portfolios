...
function copyToClipboard() {
  ...
  navigator.clipboard.writeText("kadirlofca@outlook.com");

  var tooltips = document.getElementsByClassName("tooltiptext");
  for(var i = 0; i < tooltips.length; i++) {
    tooltips[i].innerHTML = " - email copied!";
  } 


  setTimeout(clearCopyToClipboardText, 5000);
}

function clearCopyToClipboardText() {
  var tooltips = document.getElementsByClassName("tooltiptext");
  for(var i = 0; i < tooltips.length; i++) {
